...
class AdminShopController extends AdminShopControllerCore
{
	public function renderForm()
		{
			...
			$this->fields_value = array(
				...
				'phone' => (isset($shopaddress['0']['phone']) ? $shopaddress['0']['phone'] : ''),
				...
				'id_country' => (isset($shopaddress['0']['id_country']) ? $shopaddress['0']['id_country'] : ''),
	...
	public function processAdd()
	{
		...
		if (!Tools::getValue('address2'))
			$this->errors[] = $this->l('Address(Line 2) must not be empty.');
		...
		if (!Tools::getValue('phone'))
			$this->errors[] = $this->l('Phone must not be empty.');
