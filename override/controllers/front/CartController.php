	...
	protected function processChangeProductInCart()
	{
		...
		if (!$this->errors && $mode == 'add')
		{
			...
			if (!$this->errors)
			{
				...
				$update_quantity = $this->context->cart->updateQty((int)$this->qty, $this->id_product, $this->id_product_attribute, $this->customization_id, Tools::getValue('op', 'up'), $this->id_address_delivery);
