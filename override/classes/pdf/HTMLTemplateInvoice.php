...
class HTMLTemplateInvoiceCore extends HTMLTemplate
{
	...
	public function getContent()
	{
		...
		$oldNcfData = NcfOrder::getNcfdataByCartId((int)($this->order->id_cart));
		$this->smarty->assign(array(
			...
			'customer' => $customer,
			'ncfNo' => $oldNcfData['fiscal_receipt_num_p1']. $oldNcfData['fiscal_receipt_num_p2'],
			'namePerson' => $oldNcfData['rnc_name'],
			'rncId' => $oldNcfData['rnc_id'],
			'phnNo' => $oldNcfData['rnc_phone'],
			'addr' => $oldNcfData['rnc_address']
		));
