<?php /* Smarty version Smarty-3.1.14, created on 2014-07-21 11:00:34
         compiled from "D:\xampp\htdocs\bookstore\modules\blockwishlist\managewishlist.tpl" */ ?>
<?php /*%%SmartyHeaderCode:347253cca57ac88581-15822547%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ea2f15ec3d694ea97e5755699053540f17a3d987' => 
    array (
      0 => 'D:\\xampp\\htdocs\\bookstore\\modules\\blockwishlist\\managewishlist.tpl',
      1 => 1390191860,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '347253cca57ac88581-15822547',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53cca57b18bd81_34093834',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53cca57b18bd81_34093834')) {function content_53cca57b18bd81_34093834($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'D:\\xampp\\htdocs\\bookstore\\tools\\smarty\\plugins\\modifier.escape.php';
...
<?php if ($_smarty_tpl->tpl_vars['products']->value){?>
	...
	<div class="wishlistLinkTop">
		<a href="#" id="hideSendWishlist" class="button_account" onclick="WishlistVisibility('wishlistLinkTop', 'SendWishlist'); return false;" title="<?php echo smartyTranslate(array('s'=>'Close send this wishlist','mod'=>'blockwishlist'),$_smarty_tpl);?>
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'Close send this wishlist','mod'=>'blockwishlist'),$_smarty_tpl);?>
</a>
		<ul class="clearfix display_list">
			<li>
				<a href="#" id="hideBoughtProducts" class="button_account"  onclick="WishlistVisibility('wlp_bought', 'BoughtProducts'); return false;" title="<?php echo smartyTranslate(array('s'=>'Hide products','mod'=>'blockwishlist'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Hide products','mod'=>'blockwishlist'),$_smarty_tpl);?>
</a>
				<a href="#" id="showBoughtProducts" class="button_account"  onclick="WishlistVisibility('wlp_bought', 'BoughtProducts'); return false;" title="<?php echo smartyTranslate(array('s'=>'Show products','mod'=>'blockwishlist'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Show products','mod'=>'blockwishlist'),$_smarty_tpl);?>
			...
			<li>
				<a href="#" id="hideBoughtProductsInfos" class="button_account" onclick="WishlistVisibility('wlp_bought_infos', 'BoughtProductsInfos'); return false;" title="<?php echo smartyTranslate(array('s'=>"Hide products",'mod'=>'blockwishlist'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>"Hide bought product's info",'mod'=>'blockwishlist'),$_smarty_tpl);?>
</a>
				<a href="#" id="showBoughtProductsInfos" class="button_account"  onclick="WishlistVisibility('wlp_bought_infos', 'BoughtProductsInfos'); return false;" title="<?php echo smartyTranslate(array('s'=>"Show products",'mod'=>'blockwishlist'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>"Show bought product's info",'mod'=>'blockwishlist'),$_smarty_tpl);?>
</a>
			</li>
			<?php }?>
		</ul>
		<p class="wishlisturl"><?php echo smartyTranslate(array('s'=>'Permalink','mod'=>'blockwishlist'),$_smarty_tpl);?>
: <input type="text" value="<?php echo $_smarty_tpl->tpl_vars['base_dir_ssl']->value;?>
...
" style="width:540px;" readonly="readonly" /></p>
		<p class="submit">
			<a href="#" id="showSendWishlist" class="button_account exclusive" onclick="WishlistVisibility('wl_send', 'SendWishlist'); return false;" title="<?php echo smartyTranslate(array('s'=>'Send this wishlist','mod'=>'blockwishlist'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Send this wishlist','mod'=>'blockwishlist'),$_smarty_tpl);?>
</a>
		</p>
	<?php }?>
...
">
							<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['cover'],'medium_default'), ENT_QUOTES, 'UTF-8', true);?>
...
?>
			<?php if ($_smarty_tpl->tpl_vars['bought']->value['quantity']>0){?>
				<tr>
					<td class="first_item">
						<span style="float:left;"><img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['cover'],'small'), ENT_QUOTES, 'UTF-8', true);?>
" alt="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['name'], 'htmlall', 'UTF-8');?>
" /></span>			
