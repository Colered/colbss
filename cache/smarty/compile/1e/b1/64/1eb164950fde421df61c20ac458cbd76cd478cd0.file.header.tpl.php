<?php /* Smarty version Smarty-3.1.14, created on 2014-09-29 19:16:09
         compiled from "D:\xampp\htdocs\bookstore\backend\themes\default\template\header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:24433542962a10cc017-26145852%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1eb164950fde421df61c20ac458cbd76cd478cd0' => 
    array (
      0 => 'D:\\xampp\\htdocs\\bookstore\\backend\\themes\\default\\template\\header.tpl',
      1 => 1411997107,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '24433542962a10cc017-26145852',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_542962a16bdf77_05943457',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_542962a16bdf77_05943457')) {function content_542962a16bdf77_05943457($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'D:\\xampp\\htdocs\\bookstore\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<div id="container">
	...
	<div id="header">
		<div id="header_infos">
			...
			<a id="header_shopname" href="<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['url']->value;?>
<?php $_tmp1=ob_get_clean();?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getAdminLink($_tmp1), 'htmlall', 'UTF-8');?>
...
<?php $_tmp5=ob_get_clean();?><?php if ($_tmp5==1){?> selected="selected" <?php }?>><?php echo smartyTranslate(array('s'=>'catalog'),$_smarty_tpl);?>
</option>
...
<?php $_tmp6=ob_get_clean();?><?php if ($_tmp6==2){?> selected="selected" <?php }?>><?php echo smartyTranslate(array('s'=>'by name'),$_smarty_tpl);?>
</option>
							<option value="6" <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['search_type']->value;?>
<?php $_tmp7=ob_get_clean();?><?php if ($_tmp7==6){?> selected="selected" <?php }?>><?php echo smartyTranslate(array('s'=>'by ip address'),$_smarty_tpl);?>
</option>
						</optgroup>
						<option value="3" <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['search_type']->value;?>
<?php $_tmp8=ob_get_clean();?><?php if ($_tmp8==3){?> selected="selected" <?php }?>><?php echo smartyTranslate(array('s'=>'orders'),$_smarty_tpl);?>
</option>
						<option value="4" <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['search_type']->value;?>
<?php $_tmp9=ob_get_clean();?><?php if ($_tmp9==4){?> selected="selected" <?php }?>><?php echo smartyTranslate(array('s'=>'invoices'),$_smarty_tpl);?>
</option>
						<option value="5" <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['search_type']->value;?>
<?php $_tmp10=ob_get_clean();?><?php if ($_tmp10==5){?> selected="selected" <?php }?>><?php echo smartyTranslate(array('s'=>'carts'),$_smarty_tpl);?>
</option>
						<option value="7" <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['search_type']->value;?>
<?php $_tmp11=ob_get_clean();?><?php if ($_tmp11==7){?> selected="selected" <?php }?>><?php echo smartyTranslate(array('s'=>'modules'),$_smarty_tpl);?>
</option>
					</select>
