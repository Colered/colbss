...
<ul id="header_links">
	...
	<li class="header_link_myaccount"><a href="{$link->getPageLink('my-account', true)}" title="{l s='My account' mod='blockpermanentlinks'}">{l s='My account' mod='blockpermanentlinks'}</a></li>
	<li class="header_link_createanaccount"><a href="{$link->getPageLink('my-account', true)}" title="{l s='Create an account' mod='blockpermanentlinks'}">{l s='Create an account' mod='blockpermanentlinks'}</a></li>
</ul>
<!-- /Block permanent links module HEADER -->
