...
class CardNet extends PaymentModule
{
	private $_html = '';
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('CardNet');
		$this->description = $this->l('Accepts payments by credit cards with CardNet.');
	...
	{
		if (!Configuration::deleteByName('PS_OS_CARDNET') || !parent::uninstall())
			return false;
		return true;
	}
	...
	/*public function hookHeader()
	{
		...
		$process = '<script type="text/javascript">'.$this->fetchTemplate('views/js/cartnet.js').'</script>';
		return $process;
	}*/
	
	/*public function hookDisplayTop($param)
	{
		$html = '<script type="text/javascript">'.$this->fetchTemplate('views/js/cartnet.js').'</script>';
		return $html;
	}*/
	...
	public function hookPaymentReturn($params)
	{
		...
		if ($state == Configuration::get('PS_OS_CARDNET') || $state == Configuration::get('PS_OS_OUTOFSTOCK'))
		{
			$this->smarty->assign(array(
