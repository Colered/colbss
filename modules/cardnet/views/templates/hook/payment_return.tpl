...
{if $status == 'ok'}
	<p>{l s='Your order on %s is complete.' sprintf=$shop_name mod='cardnet'}
		<br /><br />{l s='Your order reference is <b>%s</b>.' sprintf=$reference mod='cardnet'}
...
{else}
	<p class="warning">
		{l s='We have noticed that there is a problem with your order. If you think this is an error, you can contact our' mod='cardnet'} 
